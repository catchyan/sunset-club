...
2. 三类检查：
   ...
   - 已知易混：体魄/耐力/体力、精力/行动力、技艺/熟练度、导师/师父
...
- ★ 至少 1 条 SOP 变更 PR（改 docs/03-process/ 或 docs/05-grokbot/skills/ 下的文件）
...
3. 检查 docs/01-game/gdd-economy.md §9.2 的 8 项稳定性判据：
   年化通胀率 -5%~+15% / 人均持有量 90 天进稳态波动<±25% / 基尼<0.55 /
   门票价格不长期贴边 / 休闲玩家 90 日财富增长>0 / 工作室 ROI ≤中度玩家1.5倍 /
   物品中位价 90 日后波动<±30% / 声望与银币相关性 |r|<0.3
