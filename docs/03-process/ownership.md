...
| `docs/03-process/framework.md` | P0 | |
| `docs/03-process/roles.md` | P0 | |
| `docs/03-process/cadence.md` | P0 | |
| `docs/03-process/ownership.md` | A1 | 需 P0 联署 |
| `docs/03-process/gates.md` | Q1 | |
| `docs/04-plan/**` | P0 | 里程碑定义变更需人类批准 |
| `docs/05-grokbot/**` | P0 | SOP 变更需 Q1 复核 + 人类批准 |
| `packages/sim/**` | E1 | |
| `packages/client/**` | E2 | |
