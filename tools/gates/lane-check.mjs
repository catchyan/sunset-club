 ...
 * G5 车道闸门。
 *
 * 唯一依据是 docs/03-process/ownership.md 的所有权表——刻意直接解析那份 markdown，
 * 而不是另建一份 JSON 配置。多一份配置就多一处会漂移的真相。
 *
 * 用法：node tools/gates/lane-check.mjs <BOT_CODE> <BASE_REF>
...
const OWNERSHIP = 'docs/03-process/ownership.md';
